  ...
  <div class="sandbox">
    ...
    > -->
      <a-assets>
        ...
        <a-asset-item
          id="gateway"
          src="/models/graveyard/Entrance2.obj"
        ></a-asset-item>
        <a-asset-item
          id="wall1"
          src="/models/graveyard/Floor_Modular.obj"
        ></a-asset-item>
        <a-asset-item
          id="building"
          src="/models/graveyard/HouseWithFlatRoof.obj"
        ></a-asset-item>

        <a-asset-item
          id="column"
          src="/models/graveyard/Column.obj"
        ></a-asset-item>
        <a-asset-item
          id="columnBroken1"
          src="/models/graveyard/Column_Broken.obj"
        ></a-asset-item>
        <a-asset-item
          id="columnBroken2"
          src="/models/graveyard/Column_Broken2.obj"
        ></a-asset-item>

        <a-asset-item
          id="gravestone1"
          src="/models/graveyard/Gravestone.obj"
        ></a-asset-item>
      </a-assets>
      <!-- Scene Background -->
